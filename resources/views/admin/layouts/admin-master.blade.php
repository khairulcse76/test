...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ asset('admin/dist/font-awesome/css/font-awesome.min.css') }}">
    <!-- Ionicons -->
    <link rel="stylesheet" href="{{ asset('admin/others/css/ionicons.min.css') }}">
    <!-- jvectormap -->
...
<div class="wrapper">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017 <a href="#">totapakhi</a>.</strong> All rights
        reserved.
    </footer>
...
<!-- Sparkline -->
<script src="{{ asset('admin/others/js/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap  -->
<script src="{{ asset('admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- SlimScroll -->
<script src="{{ asset('admin/others/js/r_componejquery.slimscroll.min.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('admin/others/js/Chart.js') }}"></script>
