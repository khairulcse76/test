...
@section('title') Admin | Manage Category @endsection
@section('pageHeader') Category Management @endsection
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($category as $item)
                        <tr>
                            <td><?php echo $id++; ?></td>
                            <td style="color:red; font-size: large; ">{{ $item->categoryName }}</td>
                            <td>
                                <a href="{{ url('authorize/edit-category/'.$item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-edit" title="Edit your Product"></span></a>
                                ...
                                <a href="{{ url('authorize/delete-cetegory/'.$item->id) }}" onclick="return check_delete()" class="btn btn-warning"><span class="glyphicon glyphicon-trash" title="Delete all information of product"></span></a>
                            </td>
                        </tr>
                    @endforeach
