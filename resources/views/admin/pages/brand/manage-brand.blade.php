...
@section('title') Admin | Manage Brand @endsection
@section('pageHeader') Brande Management @endsection
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @foreach($brands as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('authorize/edit-brand/'.$item->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-edit" title="Edit your Product"></span></a>
                                ...
                                <a href="{{ url('authorize/delete-brand/'.$item->id) }}" onclick="return check_delete()" class="btn btn-warning"><span class="glyphicon glyphicon-trash" title="Delete all information of product"></span></a>
                            </td>
                        </tr>
                    @endforeach
