...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('admin-asset/plugins/square/blue.css') }}">
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        {!! Form::open(['url' => '/admin/admin-Login-Check']) !!}
...
<!-- jQuery 3 -->
<script src="{{ asset('admin-asset/dist/js/jquery.min.js') }}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('admin-asset/dist/js/bootstrap.min.js') }}"></script>
<!-- iCheck -->
<script src="{{ asset('admin-asset/plugins/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
